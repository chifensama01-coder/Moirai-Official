...
const ITEMS = [
  { id: '1', name: 'The Scarlet Corset', category: 'Corsets', price: 'Price on request', desc: 'Structured velvet corset with dramatic fitted silhouette. Available bespoke.', image: productPhotos[8] },
  { id: '2', name: 'Heritage Blue Gown', category: 'Cameroonian Traditional', price: 'Price on request', desc: 'Cameroonian traditional reimagined in royal blue satin with bell sleeves.', image: productPhotos[9] },
  { id: '3', name: 'The Velvet Moment', category: 'Cocktail Dresses', price: 'Price on request', desc: 'Off-shoulder velvet cocktail dress. Bold, timeless, unforgettable.', image: productPhotos[10] },
  { id: '4', name: 'Bespoke Bridal Gown', category: 'Bespoke', price: 'Price on request', desc: 'Fully custom bridal gown, made to your exact measurements and vision.', image: productPhotos[11] },
  { id: '5', name: 'The Ankara Powersuit', category: 'Cameroonian Traditional', price: 'Price on request', desc: 'Bold ankara print with modern tailored trousers and statement jacket.', image: productPhotos[12] },
  { id: '6', name: 'Red Mermaid Gown', category: 'Cocktail Dresses', price: 'Price on request', desc: 'Dramatic red mermaid gown with oversized puff sleeves. Pure power.', image: productPhotos[13] },
  { id: '7', name: 'Crystal Corset Mini', category: 'Corsets', price: 'Price on request', desc: 'Crystal-trim strapless corset mini with full A-line skirt.', image: productPhotos[14] },
  { id: '8', name: 'Custom Couture Set', category: 'Bespoke', price: 'Price on request', desc: 'Bespoke two-piece, tailored to your body and your brief.', image: productPhotos[15] },
  { id: '9', name: 'Kente Off-Shoulder', category: 'Cameroonian Traditional', price: 'Price on request', desc: 'Heritage kente fabric in a modern off-shoulder cut.', image: productPhotos[16] },
  { id: '10', name: 'Black Lace Corset', category: 'Corsets', price: 'Price on request', desc: 'Black lace-overlay corset top with dramatic sleeves.', image: productPhotos[17] },
  { id: '11', name: 'Cocktail Wrap Dress', category: 'Cocktail Dresses', price: 'Price on request', desc: 'Elegant wrap silhouette in rich jewel tones.', image: productPhotos[18] },
  { id: '12', name: 'Bespoke Evening Wear', category: 'Bespoke', price: 'Price on request', desc: 'Custom evening gown for your most important occasions.', image: productPhotos[19] },
]
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      ...
                      <motion.a
                        ...
                        rel="noopener noreferrer"
                        className="btn-ghost"
                        style={{ fontSize: '9px', padding: '0.45rem 1rem', display: 'inline-block' }}
                        whileHover={{ scale: 1.04 }}
                        whileTap={{ scale: 0.97 }}
                      >Enquire</motion.a>
                    </div>
