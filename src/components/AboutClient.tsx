...
export default function AboutClient({ aboutImage }: { aboutImage?: string }) {
  return (
        ...
        <div className="container" style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
            ...
            <motion.div
              ...
              style={{ aspectRatio: '3/4', border: '1px solid #2a2133', position: 'relative', overflow: 'hidden', background: '#130f18' }}
            >
              {aboutImage && (
                <motion.img
                  src={aboutImage}
